...
const ensaladaDeFrutas = ["Manzana", "Banana", "Pera", "Kiwi", "Abacaxi"];
...
let edades = [4, 12, 17, 23, 8, 92]



for (let i = 0; i < edades.length; i++) {
    let promedio = edades[i] / edades.length
...
// Declara una función que se llama calculoMayor() y pásale como parámetros(num1, num2).
// 2. Dentro de la función muestra una alerta que diga quién de los números ingresados es mayor.En caso de ser iguales, tendrá que indicarlo a través de una alerta
// también.
...
// Crea un función tirarDado() que cuando sea ejecutada en la consola tire un
...
// Crea un objeto con el nombre toDoList debería tener las siguientes propiedades y valores: ●tipo de tarea: un string que diga "Compras"(ojo con los espacios en el nombre de la propiedad, tienes que poner entre comillas si tiene espacios)● dia: un string que indique el día a realizar la tarea.●productos: un array con los nombres de los productos.●cantidad de productos: un número que indica la cantidad de productos de las
...
const frase = frases.map((item, index) => `¡${item}!`);
